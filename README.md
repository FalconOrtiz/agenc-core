...
| Package | Path | Role |
| --- | --- | --- |
| `@tetsuo-ai/agenc` `0.16.1` | `packages/agenc/` | Public launcher binary |
| `@tetsuo-ai/runtime` `0.16.1` | `runtime/` | Daemon, TUI, tools, providers, tests |
...
**Current version in tree: 0.16.1.** Runtime and launcher are versioned
`0.16.1`; the embedding SDK package is `0.3.0`. The public launcher is
