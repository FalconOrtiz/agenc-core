...
A current map of how `agenc` is put together (runtime **0.16.1**). For the
...
| `build/` / `version.ts` / `index.ts`                                     | Feature flags, version stamp (`0.16.1`), public barrel                                                                                                                                                                                         |
