...
| `mcp-client/` / `mcp-server/` / `mcp/`                                   | Outbound MCP client, server framework, and serve bootstrap. Plugin merge, model-facing inputSchema sanitization, stderr retention, and Landlock stdio failures: [mcp.md](reference/mcp.md#model-facing-inputschema-sanitization).                                                                                            |
